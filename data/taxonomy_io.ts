...
export const TAXO_IO: Record<string, TaxoIO> = {
  ...
  tool_apply_clarify_proposal: { inputs: [{ name: "action", required: true }, { name: "fields" }] },
  ...
  tool_close_direction: { inputs: [{ name: "direction_id", required: true }, { name: "kind", required: true }] },
  tool_close_focus: { inputs: [{ name: "focus_id", required: true }, { name: "kind", required: true }, { name: "confirm" }] },
  ...
  tool_create_feedback: { inputs: [{ name: "content", required: true }, { name: "type", required: true }, { name: "summary" }], outputs: ["confirmation"] },
  tool_create_focus: { inputs: [{ name: "destination", required: true }, { name: "name" }, { name: "initial_status" }, { name: "tags" }, { name: "type" }, { name: "sphere_id" }] },
  tool_create_item: { inputs: [{ name: "type", required: true }, { name: "title", required: true }, { name: "content" }, { name: "focus" }, { name: "status" }, { name: "properties" }, { name: "tags" }], outputs: ["created item with ID"] },
  tool_create_kb_article: { inputs: [{ name: "question", required: true }, { name: "answer", required: true }, { name: "topic" }, { name: "product" }, { name: "status" }] },
  tool_create_sphere: { inputs: [{ name: "name", required: true }, { name: "emoji" }, { name: "description" }] },
  tool_create_ticket: { inputs: [{ name: "type", required: true }, { name: "summary", required: true }, { name: "user_message", required: true }, { name: "priority" }] },
  ...
  tool_enter_tunneling: { inputs: [{ name: "focus_id", required: true }, { name: "reason", required: true }, { name: "initiator" }] },
  ...
  tool_get_context: { inputs: [{ name: "file", required: true }] },
  ...
  tool_link_attachment: { inputs: [{ name: "attachment_id", required: true }, { name: "entity_type", required: true }, { name: "entity_id", required: true }] },
  tool_link_entities: { inputs: [{ name: "source_id", required: true }, { name: "target_id", required: true }, { name: "relation", required: true }, { name: "reason" }, { name: "confirm" }] },
  ...
  tool_list_spheres: { outputs: ["each sphere with id, name, emoji, kind"] },
  ...
  tool_rewire_locus_record: { inputs: [{ name: "record_id", required: true }, { name: "new_kind", required: true }, { name: "new_id", required: true }] },
  tool_search_history: { inputs: [{ name: "source", required: true }, { name: "query" }, { name: "days" }, { name: "limit" }] },
  tool_search_items: { inputs: [{ name: "query", required: true }, { name: "type" }, { name: "mode" }, { name: "limit" }] },
  tool_search_kb: { inputs: [{ name: "query", required: true }] },
  tool_search_knowledge: { inputs: [{ name: "query", required: true }] },
  tool_search_locus_history: { inputs: [{ name: "query", required: true }, { name: "limit" }, { name: "addressing_kind" }, { name: "addressing_id" }] },
  ...
  tool_set_silence_declaration: { inputs: [{ name: "type", required: true }, { name: "target_kind" }, { name: "target_id" }, { name: "target_label" }, { name: "expires_in_hours" }, { name: "reason" }] },
  tool_set_trajectory_phase: { inputs: [{ name: "entry_id", required: true }, { name: "new_phase", required: true }, { name: "content" }, { name: "recorded_at" }, { name: "position" }] },
  tool_unbind_resource: { inputs: [{ name: "focus_id", required: true }, { name: "connector", required: true }, { name: "external_id", required: true }] },
  tool_update_context: { inputs: [{ name: "file", required: true }, { name: "section", required: true }, { name: "action", required: true }, { name: "content", required: true }, { name: "dry_run" }] },
  tool_update_direction: { inputs: [{ name: "direction_id", required: true }, { name: "status" }, { name: "title" }, { name: "destination" }, { name: "confirmed" }, { name: "cascade_focuses" }, { name: "reason" }] },
  tool_update_focus: { inputs: [{ name: "focus_name", required: true }, { name: "name" }, { name: "status" }, { name: "locus" }, { name: "destination" }, { name: "confirmed" }, { name: "direction" }, { name: "main" }, { name: "pause_reason" }, { name: "resume_condition" }] },
  tool_update_identity: { inputs: [{ name: "action", required: true }, { name: "id" }, { name: "text" }, { name: "category" }, { name: "sphere_id" }] },
  ...
  tool_update_schedule: { inputs: [{ name: "active_start" }, { name: "active_end" }, { name: "intensity" }, { name: "mode" }, { name: "monthly_review" }, { name: "weekly_review_weekday" }, { name: "calendar_sync_pref" }] },
